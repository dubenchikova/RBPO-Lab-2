...
double RBPO::Lab2::Variant9::Task2::f1(double x, double y) {
	return (cos(x) - cos(y)) * (cos(x) - cos(y)) - (sin(x) - (-1) * sin(y)) * (sin(x) - (-1) * sin(y));
};

double RBPO::Lab2::Variant9::Task2::f2(double x) {
	if (x > 3.6)
		return 45 * x * x + 5;
	return 5 * x / (10 * x * x + 1);
};

double RBPO::Lab2::Variant9::Task2::f3(unsigned long long n) {
...
double RBPO::Lab2::Variant9::Task2::f4(double eps) {
...
double RBPO::Lab2::Variant9::Task2::a(long long i) {
